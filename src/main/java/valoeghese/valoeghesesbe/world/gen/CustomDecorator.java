...
public class CustomDecorator extends BiomeDecorator
{
	 ...
	 * Used in a for loop
	 */
	public int waterLakeChances = 50;
	/**
	 * Default 20
	 * 
	 * Used in a for loop
	 */
	public int lavaLakeChances = 20;
	@Override
	protected void genDecorations(Biome biomeIn, World worldIn, Random random)
    {
        ...
        if (this.generateFalls)
        {
            ...
            for (int k5 = 0; k5 < this.waterLakeChances; ++k5)
            {
            ...
            for (int l5 = 0; l5 < this.lavaLakeChances; ++l5)
            {
	...
	public CustomDecorator setLakeChances(int waterLakeChances, int lavaLakeChances)
	{
		
		this.waterLakeChances = waterLakeChances;
		this.lavaLakeChances = lavaLakeChances;
		return this;
	}
}
