...
/*
 * 
 * Note this tree isn't really a palm.. It's more of an "oasis tree." (which is what I listed it as in the mod wiki)
 * 
 * It's listed as a palm because that's what it was originally meant to be (back in Public Alpha 1.1).
 */

public class WorldGenOasisPalm extends WorldGenAbstractTree
{
    ...
    public WorldGenOasisPalm(boolean doBlockNotify)
    {
        super(doBlockNotify);
    }
