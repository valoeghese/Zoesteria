package valoeghese.valoeghesesbe.archived;
...
public class ChunkGeneratorSmooth implements IChunkGenerator
{
	protected static final IBlockState STONE = Blocks.STONE.getDefaultState();
	private final Random rand;
	/**
	 * Controls some small hills at some points in terrain generation, subtle changes at high octaves
	 * 
	 * Gives cool formations when combined with maxLimitPerlinNoise
	 */
	private NoiseGeneratorOctaves minLimitPerlinNoise;
	
	/**
	 * Bigger affect on height variation in biomes. subtle changes at high octaves
	 * 
	 * Gives cool formations when combined with minLimitPerlinNoise
	 */
	private NoiseGeneratorOctaves maxLimitPerlinNoise;
	
	/**
	 * Does not effect subtle changes. Possibly scales the min and max perlin noises
	 */
	...
	public ChunkGeneratorSmooth(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
	{
		...
		this.surfaceNoise = new NoiseGeneratorPerlin(this.rand, 10);
		this.scaleNoise = new NoiseGeneratorOctaves(this.rand, 2);
		this.depthNoise = new NoiseGeneratorOctaves(this.rand, 2);
		this.forestNoise = new NoiseGeneratorOctaves(this.rand, 2);
	 ...
	 public Chunk generateChunk(int x, int z)
	{
	 ...
	 public void populate(int x, int z)
	 {
		 ...
		 if (!(biome instanceof ILakeRemover))
		 {
