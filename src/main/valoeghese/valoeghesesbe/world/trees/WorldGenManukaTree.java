...
public class WorldGenManukaTree extends WorldGenAbstractTree
{
	...
	public WorldGenManukaTree()
	{
		super(false);
	}
	public WorldGenManukaTree(boolean notify)
	{
		super(notify);
	}
	...
	{
		int theight = rand.nextInt(2) + minBasicHeight + 1;
		int trunk = 1;
